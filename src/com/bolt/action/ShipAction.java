...
public class ShipAction extends ActionSupport{
	...
	public void sendMail(Ship ship, String host){
		...
		String content = ship.getCustomer().getName() + ", pembayaran anda telah kami terima. \n" +
				"ID pemesanan anda di boltstore adalah "+ship.getShipId()+" dengan total harga :\n\n" +
				"IDR "+totalPrice+" \n" +
				...
				"Terima kasih. \n\n" +
				"*NB. Untuk info lebih lanjut, silahkan hubungi kami melalui nomor HP. 081216438899 atau email boltstore@gmail.com.";
