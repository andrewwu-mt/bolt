...
public class ProductAction extends ActionSupport{
	...
	public String saveRecord(){
		try{
			...
			String path = "C:/apache-tomcat-7.0.54/webapps/bolt/products/";
			if(!osName.contains("Windows")) path = "/usr/share/tomcat/webapps/bolt/products/";
