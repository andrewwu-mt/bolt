...
<head>
    ...
    <title>Bolt Store Liquor Indonesia | Jual Miras | Spirits & Wine</title>
	...
	<script>
	  ...
	  ga('create', 'UA-50983431-1', 'boltstore.com');
	  ga('send', 'pageview');
  ...
  <div class="modal-dialog">
    <div class="modal-content  center">
      <div class="modal-header">
        ...
        <h3><span class="light">Register</span> to boltstore</h3>
        <hr class="divider">
      </div>
...
<div class="modal  fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content  center">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3><span class="light">Login</span> to boltstore</h3>
        <hr class="divider">
      </div>
      <div class="modal-body">
    ...
    <ul class="nav  navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="bolt-list" >Bolt Collections</a></li>
        </ul>
      </li>
      <li class="dropdown">
