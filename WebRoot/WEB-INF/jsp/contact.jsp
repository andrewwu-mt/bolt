    ...
    <div class="col-xs-12">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-3">
          <h2 class="no-margin">boltstore</h2><br/>
          ...
          <span class="glyphicon  glyphicon-envelope"></span> <a class="secondary-link" href="http://www.gmail.com" target="_blank"><strong>boltstore@gmail.com</strong></a>
        </div>
      </div>
    </div>
  </div>
